...
export default function HomePage() {
  return (
    <div className="flex items-center sm:justify-center flex-col h-full w-full">
      <div className="text-center mb-6 min-w-[350px] max-w-[630px] space-y-[6px] px-3 max-sm:pt-[100px]">
