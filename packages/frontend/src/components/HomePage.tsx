...
export default function HomePage() {
  return (
    <div className="flex items-center min-[578px]:justify-center flex-col h-full w-full space-y-5">
      <div className="text-center mb-6 max-w-[578px] space-y-[6px] mt-[100px] pb-[30px]">
